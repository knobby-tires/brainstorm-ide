 ...
 */
export function compile_and_run(input) {
...
export class ExecutionResult {
    ...
    get output() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.executionresult_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get memory() {
        const ret = wasm.executionresult_memory(this.__wbg_ptr);
     ...
     */
    get pointer() {
        const ret = wasm.executionresult_pointer(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get error() {
        const ret = wasm.executionresult_error(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('brainfuck_compiler_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
